...
//Quelle: https://de.wikipedia.org/wiki/Umrechnung_zwischen_julianischem_Datum_und_julianischem_Kalender#Berechnung_des_laufenden_Tages
...
class Kalenderdatum
{
	...
	public:
		...
		void ausgabe_days(){
			cout << "Für Ihre Eingabe sind seit dem 01.01.4713 v.Chr. " << lt << " Tage vergangen.\n";
		}
...
int main (){
		//Erstelle ein Kalenderobjekt
		Kalenderdatum date1(19);
		
		
		//Variablen die die Eingabeentscheidung speichern
		int decide1 = 4;
		int decide2 = 4;
		...
		cout << "\n";
		switch ( decide1 ){
		case 1 :	date1.einlesen_greg();
				date1.greg_to_lt();
				break;
		case 2 :	date1.einlesen_jul();
				date1.jul_to_lt();
				break;
		case 3 : date1.einlesen_days(); break;
		...
		cout << "\n";
		switch ( decide2 ){
		case 1 :	date1.lt_to_greg();
				date1.ausgabe_greg();
				break;
		case 2 : 	date1.lt_to_jul();
				date1.ausgabe_jul();
				break;
		case 3 : date1.ausgabe_days(); break;
		default : cout << "Ungültige Auswahl, bitte nochmal\n1) Für ein Datum im gregorianischen Kalender\n2) Für ein Datum im julianischen Kalender\n3) Für eine Anzahl von vergangenen Tagen seit dem 01.01.4713 v.Chr.\n";
		}
		}
}